...
//
	    final TextView txtHelp = (TextView) findViewById(R.id.txt_help);
	    txtHelp.setMovementMethod(new ScrollingMovementMethod());
//	    txtResult.setText(newText);
/*
	    Button btnBack = (Button) findViewById(R.id.btn_bck_help);
...
//	            i.putExtra("ARRIVING_FROM", "screen 1");
	    ...
	    Button btnExit = (Button) findViewById(R.id.btn_exit_help);
